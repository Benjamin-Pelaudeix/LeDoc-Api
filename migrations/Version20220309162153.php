 ...
 */
final class Version20220309162153 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE document (id INT AUTO_INCREMENT NOT NULL, patient_id INT NOT NULL, name VARCHAR(255) NOT NULL, upload_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_ordonnance TINYINT(1) NOT NULL, INDEX IDX_D8698A766B899279 (patient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE meet (id INT AUTO_INCREMENT NOT NULL, tour_id INT DEFAULT NULL, subject VARCHAR(255) NOT NULL, start_date_time DATETIME NOT NULL, notes VARCHAR(255) NOT NULL, is_video TINYINT(1) NOT NULL, is_urgent TINYINT(1) NOT NULL, INDEX IDX_E9F6D3CE15ED8D43 (tour_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE treatment (id INT AUTO_INCREMENT NOT NULL, patient_id INT DEFAULT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, repeats LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_98013C316B899279 (patient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
